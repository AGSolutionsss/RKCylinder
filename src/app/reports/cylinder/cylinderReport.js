...
const CylinderReport = (props) => {
    ...
    const [cylinderDownload, setCylinderDownload] = useState([]);
        ...
        let data = {
            ...
            cylinder_vendor: localStorage.getItem("cylinder_vendor"),
        };

        axios({
            url: baseURL+"/fetch-cylinder-report",
            method: "POST",
            data,
            headers: {
                                    ...
                                    <table className="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style={table_head}>No of Cylinder</th>
                                        ...
                                        <tbody>
                                            {cylinderDownload.map((dataSumm, key)=>(
                                                <tr>
                                                    ...
                                                    <td style={table_row}>{dataSumm.cylinder_batch_nos}</td>
                                                    <td style={table_row}>{dataSumm.cylinder_count}</td>
                                                    <td style={table_row}>{dataSumm.cylinder_status}</td>
                                                </tr>
                                            ))}
                                        </tbody>
                                    </table>
