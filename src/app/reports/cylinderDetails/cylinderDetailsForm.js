...
const CylinderDetailsForm = (props) => {
    ...
    const onSubmit = (e) => {
        ...
        let data = {
            ...
            cylinder_manufacturer: cylinderDownload.cylinder_manufacturer,
        };
        e.preventDefault();
    ...
    const onReportView = (e) => {
        ...
        localStorage.setItem('cylinder_manufacturer',cylinderDownload.cylinder_manufacturer);
        history.push("/reportCylinderDetails");
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-sm-12 col-md-4 col-xl-4">
                                        <div className="form-group">
                                            ...
                                            value={cylinderDownload.cylinder_manufacturer}
                                            onChange={(e) => onInputChange(e)}
                                            >
                                                {manufacturer.map((vendorName, key) => (
                                                    <MenuItem key={key} value={vendorName.id}>
                                                        {vendorName.manufacturer_name}
                                                    </MenuItem>
                                                ))}
                                            </TextField>
                                        </div>
...
export default CylinderDetailsForm;